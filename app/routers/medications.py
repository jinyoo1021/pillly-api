...
async def create_medication(
    ...
    return medication_service.create(user.id, req)
...
async def toggle_medication(
    ...
    return medication_service.toggle(medication_id, user.id)
...
async def update_medication(
    ...
    return medication_service.update(medication_id, user.id, req)
...
async def delete_medication(
    ...
    medication_service.delete(medication_id, user.id)
